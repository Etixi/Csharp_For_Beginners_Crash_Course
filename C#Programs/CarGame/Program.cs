...
namespace CarGame
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            batmobile.Units = SpeedUnits.Knots;
    ...
    class Car
    {
        ...
        private const double mphToKph = 1.60934;
        ...
        public int Speed
        {
            ...
            private set
            {
                double convertedMaxSpeed = maxSpeed;
                if (Units == SpeedUnits.Kph)
                {
                    convertedMaxSpeed *= mphToKph;
                }
                else if (Units == SpeedUnits.Knots)
                {
                    convertedMaxSpeed *= mphToKnots;
                }

                if (value < convertedMaxSpeed)
                {
                    _speed = value;
                }
                else
                {
                    _speed = Convert.ToInt32(convertedMaxSpeed);
                }
            }
        }
