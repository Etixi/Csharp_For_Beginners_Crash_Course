namespace RockPapersScissors
{
    ...
    {
        private const int Rock = 0;     // beats Scissors. (Scissors + ) % 3 = 0
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine($"Computer choice {computerChoice}, player chose {playerChoice}");
            ...
            } while (GetYesOrNo("Would you like play again?"));
        }
